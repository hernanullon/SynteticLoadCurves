...
As análises para operação e planejamento em sistemas de distribuição de energia elétrica são tipicamente realizadas a partir de curvas de carga típicas que dependem da natureza das cargas de cada unidade consumidora (UC). O recente aumento no número de unidades de Geração Distribuída conectadas aos sistemas de distribuição tem representado um grande desafio para a operação e planejamento deses sistemas de distribuição pois a potência de saída dessas unidades é influenciada pelas condições climáticas, sendo alterada de acordo com as condições climáticas. Para contornar esse problema e contabilizar essas incertezas, este trabalho propõem a adoção de uma abordagem baseada na geração de conjuntos de possíveis cenários de geração/consumo na forma de séries temporais através da caracterização e da quantificação dos perfis de consumo de energia elétrica a partir de dados coletados nos sistema de distribuição do campus da UNICAMP em Barão Geraldo usando o modelo generativo NICE. A partir da análise das curvas de carga é possível identificar um conjunto de diversas informações sobre o desempenho energético destes consumidores, possibilitando a realização de diferentes estudos.
...
<p align="center">
	<img src="https://github.com/hernanullon/SynteticLoadCurves/blob/main/reports/figures/0.png" width="250" >
	<img src="https://github.com/hernanullon/SynteticLoadCurves/blob/main/reports/figures/1.png" width="250" >
	<img src="https://github.com/hernanullon/SynteticLoadCurves/blob/main/reports/figures/2.png" width="250" >
	<img src="https://github.com/hernanullon/SynteticLoadCurves/blob/main/reports/figures/3.png" width="250" >
	<img src="https://github.com/hernanullon/SynteticLoadCurves/blob/main/reports/figures/4.png" width="250" >
	<img src="https://github.com/hernanullon/SynteticLoadCurves/blob/main/reports/figures/5.png" width="250">
	<figcaption>
...
Para o cálculo da divergencia Kullback-Leibler foram computadas as curvas de distribuição das curvas de carga reais e sintéticas para cada transformador, como mostrado na Figura 9. Pode-se analisar visualmente que as distribuições de probabilidade com menos similitude são das classes  2, 3, e 5.
<p align="center">	        
...
Usando as distribuições de probabilidade, calculamos a divergencia Kullback-Leibler das curvas sintéticas em relação com as curvas reais (KL_RS). Os valores apresentados na Tabela 5 permitem comprovar que as curvas das classes 1, 2 e 4 foram geradas com maior semelhança, posto que a medida KL é menor. Mesmo a classe 3 que tem a maior KL_RS está por baixo de 0.3, valor considerado aceitável para curvas de carga sintéticas. 
